...
This repository contains configuration files and scripts to fully automate the process of deploying an HTTP service written in Swift to AWS in a matter of seconds using the Serverless Framework. Made with 💘 by the folks @ [Stream](https://getstream.io).
